...
module.exports = function () {
	...
	_helpers.jurisdictionList = function(jurisdiction, options) {
		var slug = jurisdiction.slug;
		...
		var link = linkTemplate({
			url: ('/laws/jurisdiction/' + slug),
			text: _.escape(jurisdiction.name),
		})
	...
	_helpers.actUrl = function (slug, options) {
		return ('/laws/act/' + slug);
	};
	...
	_helpers.categoryUrl = function (categorySlug, options) {
		return ('/laws/category/' + categorySlug);
	};
